  ...
  describe('Product Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Category query and add missing value', () => {
        ...
        const product_category: ICategory = { id: 52954 };
        product.product_category = product_category;

        const categoryCollection: ICategory[] = [{ id: 63621 }];
        jest.spyOn(categoryService, 'query').mockReturnValue(of(new HttpResponse({ body: categoryCollection })));
        const additionalCategories = [product_category];
      ...
      it('Should update editForm', () => {
        const product: IProduct = { id: 456 };
        const product_category: ICategory = { id: 32126 };
        product.product_category = product_category;
        ...
        expect(comp.categoriesSharedCollection).toContain(product_category);
      });
    });
